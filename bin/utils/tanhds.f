...
c***********************************************************************
c
      subroutine tanhds (sp1, sp2, s, status, ns)
c
c***************
c
...
c     input variables
      ...
      integer, intent(inout) :: ns, status
      real(8), intent(inout) :: sp1,sp2
      real(8), intent(inout), dimension(ns) :: s
        
     
      integer i, j, iter, itmx, n, nm1, nsmid
c
      real*8
     .   si, sj,
